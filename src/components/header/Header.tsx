...
export const Header = () => {
  return (
    <div className="app-bar grid s-b a-i-c">
      <div className="logo-box col ml-2 ">
        <svg  viewBox="0 0 202 115">
          <g stroke="#b92b27" fill-rule="evenodd" className="logo_fill">
      ...
      <nav className="app-bar-nav col ml-8">
        <ul className="app-bar-list grid s-a">

          <Link className="list-item" to="home" >Home</Link>
          <Link className="list-item" to="create">Create Post</Link>
          <Link className="list-item" to="/post-card">Post card</Link>
